...
\begin{itemize}
    ...
    \item
          ...
          {\emph{2022 -- Present}}
          \begin{itemize*}
              \item Managed and maintained multiple game servers, docker containers, boxes, and front-end Xenforo sites.
              \item Implemented GitLab CI to streamline development within Docker instances.
              \item Created projects varying from Source plugins to Discord bots, utilizing languages including C, TypeScript, and Python.
              \item Worked with a team to ensure tasks, goals, and issues were completed in a timely manner.
          \end{itemize*}
...
\begin{itemize}
    ...
    \item
          ...
          \begin{itemize*}
              ...
              \item Expanded tech stack to include \LaTeX, GitHub Codespaces, and Remote SSH Development.
          \end{itemize*}
    \item
          \headerrow
