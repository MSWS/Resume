...
\begin{itemize}
    ...
    \item
          ...
          {\emph{2022 -- Present}}
          \begin{itemize*}
              \item Created new projects and maintained existing ones for the organization.
              \item Maintained core infrastructure including databases, web and game servers.
              \item Set up separate production / development servers using Docker with GitLab integration.
              \item Drove the development and deployment of servers and features with an emphasis on open-sourcing projects.
          \end{itemize*}
    \item
          \headerrow
          {\textbf{Homelab}}
